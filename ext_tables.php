...
call_user_func(function() {
    ...
    \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addLLrefForTCAdescr(
        'tx_waconcookiemanagement_domain_model_cookie',
        'EXT:wacon_cookie_management/Resources/Private/Language/locallang_csh_tx_waconcookiemanagement_domain_model_cookie.xlf'
    );
